...
const StatCard: React.FC<StatCardProps> = ({ label, value, unit, children, className, indicatorColor }) => (
  <div className={`p-4 rounded-2xl bg-gray-700/50 border border-gray-600 shadow-md ${className}`}>
  ...
  return (
    <div className="bg-gray-800/50 backdrop-blur-sm rounded-2xl p-5 shadow-lg border border-gray-700">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <StatCard label="Fuel Level" value={fmtNumber(currentFuelL, 2)} unit="Liters" className="col-span-2">
